\documentclass[aspectratio=169, t, 10pt, ignorenonframetext]{beamer}
\usetheme{Boadilla}
...
\column{.55\textwidth}%
    ...
    \begin{itemize}
        \item Assessment of uncertainties
...
\column[T]{.44\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \begin{semilogyaxis}[width=\textwidth, height=0.9\textheight,
                 ...
                 tick label style={font=\tiny}, legend style={only marks, draw=none, font=\footnotesize},
