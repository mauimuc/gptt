...
\begin{frame}
    ...
    \framesubtitle{Surface Wave Tomography -- Having an application with ambient noise records in mind }
...
\column{.55\textwidth}%
    ...
    \begin{equation}
        \Cov{V}{T_{s,r}[V]\,} \approx -\int_C \frac {K_V(\cdot,r)}{\mu_V(r)^2} \mathrm d r
    \end{equation}
    \end{block}
    ...
    \begin{equation}
        \Cov{T_{s,r}[V]}{T_{\acute s, \acute r}[V]\,} \approx  \int_C \int_{\acute C} \frac{K_V(r,\acute r)}{\mu_V(r)^2\mu_V(\acute r)^2} \mathrm d r \mathrm d \acute r
    \end{equation}
    \end{block}
