...
It is the ray path -- i.e.~the distance -- depending upon the model which in turn is unknown!
Although the average slowness is a decent observable, I stay with travel times since this is what I begun working with.}
